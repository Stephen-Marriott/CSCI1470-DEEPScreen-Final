...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr 26 17:14:39 2025
...
class DeepScreen_Tensorflow(tf.keras.Model):

    def __init__(self, fully_layer_1, fully_layer_2, drop_rate):
        super(DeepScreen_Tensorflow, self).__init__()
        ...
        self.conv3 = tf.keras.layers.Conv2D(28, 2)
        ...
        self.conv4 = tf.keras.layers.Conv2D(64, 2)
