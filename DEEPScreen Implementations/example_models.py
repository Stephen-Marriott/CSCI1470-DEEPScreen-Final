...
result_list = []
train_imgs,train_labels,val_imgs,val_labels,test_imgs,test_labels = get_protein_data(target, dd)
...
for model_type in model_types:
    ...
    history_df['Model Type'] = model_type
    
    full_history = pd.concat([full_history,history_df])
...
full_history.to_csv('CHEMBL286 Full Results '+str(date.today())+'.csv',index=False)
